...
public class MaxFeeTxHandler {
    ...
    public Transaction[] handleTxs(Transaction[] possibleTxs) {
        ...
        Set<Transaction> validTxs = new TreeSet<>((tx1, tx2) -> {
        	return Double.valueOf(calculateFee(tx1)).compareTo(Double.valueOf(calculateFee(tx2)));
        });
    	Collections.addAll(validTxs, possibleTxs);
